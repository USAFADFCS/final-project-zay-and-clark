...
To run:
Run one of the above commands in your terminal.
The framework will output a summary in the terminal and generate a report.html file.
Open the report.html file in your browser to view results and recommended actions.
